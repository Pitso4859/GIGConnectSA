      ...
      <div className="max-w-2xl space-y-6">
        ...
        {editing && (
            <div className="card p-6 space-y-4">
              ...
              <div><label className="label">Full Name</label><input className="input" value={form.fullName} onChange={f('fullName')}/></div>
              <div><label className="label">Phone</label><input className="input" placeholder="071 000 0000" value={form.phone} onChange={f('phone')}/></div>
              <div><label className="label">Location</label><input className="input" placeholder="City, Province" value={form.location} onChange={f('location')}/></div>
              <div><label className="label">Bio</label><textarea rows={4} className="input resize-none" placeholder="Tell clients about your skills and experience…" value={form.bio} onChange={f('bio')}/></div>
              <div><label className="label">Avatar URL</label><input className="input" placeholder="https://..." value={form.avatarUrl} onChange={f('avatarUrl')}/></div>
            </div>
        )}
