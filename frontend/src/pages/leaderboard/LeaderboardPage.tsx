...
import { IconTrophy, IconStar, IconBriefcase, BADGE_STYLES } from '../../components/icons/Icons';
                    ...
                    #{entry.rank}
                      ...
                      <div className="text-right shrink-0">
                        <div className="flex items-center gap-1">
                          {[1,2,3,4,5].map(n => <div key={n} className={clsx('w-2 h-2 rounded-full', n <= Math.round(entry.averageRating) ? 'bg-amber-400' : 'bg-slate-100')}/>)}
                        </div>
