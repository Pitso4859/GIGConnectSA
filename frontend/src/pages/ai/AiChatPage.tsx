...
import { IconSparkles, IconSend, IconRefreshCw, IconUser } from '../../components/icons/Icons';
              ...
              <div key={i} className={clsx('flex gap-3', msg.role === 'USER' ? 'flex-row-reverse' : 'flex-row')}>
                ...
                <div className={clsx('max-w-[80%] rounded-2xl px-4 py-3 text-sm leading-relaxed',
                  msg.role === 'USER'
                    ...
                    : 'bg-white border border-slate-100 text-slate-800 shadow-card rounded-tl-sm')}>
